...
if( isset($_POST['submit']) ){
        ...
        $tlp      = stripslashes($_POST['tlp']);
        $tlp      = mysqli_real_escape_string($db, $tlp);
        ...
        if(!empty(trim($nama)) && !empty(trim($username)) && !empty(trim($email)) && !empty(trim($password)) && !empty(trim($repass))){
            ...
            if($password == $repass){
                ...
                if( cek_nama($nama,$db) == 0 ){
                    ...
                    $query = "INSERT INTO user (user_nama, user_username, user_password, user_tlp, user_email) VALUES ('$nama','$username','$password','$tlp','$email')";
        ...
        <section class="container-fluid mb-4">
            ...
            <section class="row justify-content-center">
             <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="daftar.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tlp" name="tlp" placeholder="Masukkan no. telepon">
                    </div>
                    <div class="form-group">
